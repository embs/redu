...
gem 'aasm'
gem 'premailer-rails', git: 'https://github.com/fphilipe/premailer-rails', branch: :main
gem 'classy_enum'
...
gem 'invitable', git: 'https://github.com/embs/invitable.git', branch: :main
